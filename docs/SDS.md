...
**Описание.** Вариант использования "Купить продукт из списка покупок" позволяет удалить продукт из списка покупок и добовить его в холодильник либо на полку, при этом указывая дополнительные характеристики продукта: срок годности, количество, фото.
